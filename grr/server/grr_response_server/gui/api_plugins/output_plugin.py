...
def ApiOutputPluginDescriptorFromProtoClass(
  ...
  if plugin_class.args_type:  # pyrefly: ignore[missing-attribute]
    res.args_type = (
        f"type.googleapis.com/{plugin_class.args_type.DESCRIPTOR.full_name}"  # pyrefly: ignore[missing-attribute]
    )
