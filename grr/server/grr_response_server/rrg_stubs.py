...
def GetFileContentsKmx() -> Action[rrg_get_file_contents_kmx_pb2.Args]:
  return Action(
      action=rrg_pb2.Action.GET_FILE_CONTENTS_KMX,
      args_type=rrg_get_file_contents_kmx_pb2.Args,
  )
...
def GetFileSha256Kmx() -> Action[rrg_get_file_sha256_kmx_pb2.Args]:
  return Action(
      action=rrg_pb2.Action.GET_FILE_SHA256_KMX,
      args_type=rrg_get_file_sha256_kmx_pb2.Args,
  )
...
def ListConnections() -> Action[empty_pb2.Empty]:
  return Action(
      action=rrg_pb2.Action.LIST_CONNECTIONS,
      args_type=empty_pb2.Empty,
  )
...
def ListProcesses() -> Action[rrg_list_processes_pb2.Args]:
  return Action(
      action=rrg_pb2.Action.LIST_PROCESSES,
      args_type=rrg_list_processes_pb2.Args,
  )
