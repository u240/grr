...
class YaraProcessScanMatchConverterProto(
  ...
  output_proto_types = (export_pb2.ExportedYaraProcessScanMatch,)  # pyrefly: ignore[bad-assignment]
...
class ProcessMemoryErrorConverterProto(
  ...
  output_proto_types = (export_pb2.ExportedProcessMemoryError,)  # pyrefly: ignore[bad-assignment]
