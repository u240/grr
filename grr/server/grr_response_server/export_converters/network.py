...
class NetworkConnectionToExportedNetworkConnectionConverterProto(
  ...
  output_proto_types = (export_pb2.ExportedNetworkConnection,)  # pyrefly: ignore[bad-assignment]
...
class InterfaceToExportedNetworkInterfaceConverterProto(
  ...
  output_proto_types = (export_pb2.ExportedNetworkInterface,)  # pyrefly: ignore[bad-assignment]
...
class DNSClientConfigurationToExportedDNSClientConfigurationProto(
  ...
  output_proto_types = (export_pb2.ExportedDNSClientConfiguration,)  # pyrefly: ignore[bad-assignment]
