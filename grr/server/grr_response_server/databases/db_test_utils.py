...
class QueryTestHelpersMixin(object):
  ...
  def DoOffsetAndCountTest(
    ...
    self.assertNotEmpty(  # pyrefly: ignore[missing-attribute]
    ...
    for i in range(len(all_objects)):
      for l in range(1, len(all_objects) + 1):
        ...
        self.assertListEqual(  # pyrefly: ignore[missing-attribute]
            results,
            expected,
  ...
  def DoFilterCombinationsTest(
    ...
    self.assertNotEmpty(perms)  # pyrefly: ignore[missing-attribute]
